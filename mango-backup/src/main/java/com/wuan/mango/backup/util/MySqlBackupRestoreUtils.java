package com.wuan.mango.backup.util;
...
public class MySqlBackupRestoreUtils {
	...
	public static boolean backup(String host, String userName, String password, String backupFolderPath, String fileName,
		...
		stringBuilder.append(" --column-statistics=0");
...
/*
      host: jdbc:mysql://121.199.70.205/mango?characterEncoding=utf-8&useSSL=false
      userName: root
      password: i@gx3296
      database: mango
...
*/
	public static void main(String[] args) throws Exception {
		String host = "121.199.70.205";
		String userName = "root";
		String password = "i@gx3296";
